About pixi-ros-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pixi-ros-feedstock/blob/main/LICENSE.txt)

Home: https://github.com/ruben-arts/pixi-ros

Package license: MIT

Summary: Pixi extension for ROS package management

Development: https://github.com/ruben-arts/pixi-ros
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=27280&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pixi-ros-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
| --- | --- | --- | --- |
| [![Conda Recipe](https://img.shields.io/badge/recipe-pixi--ros-green.svg)](https://anaconda.org/conda-forge/pixi-ros) | [![Conda Downloads](https://img.shields.io/conda/dn/conda-forge/pixi-ros.svg)](https://anaconda.org/conda-forge/pixi-ros) | [![Conda Version](https://img.shields.io/conda/vn/conda-forge/pixi-ros.svg)](https://anaconda.org/conda-forge/pixi-ros) | [![Conda Platforms](https://img.shields.io/conda/pn/conda-forge/pixi-ros.svg)](https://anaconda.org/conda-forge/pixi-ros) |

Installing pixi-ros
===================

Installing `pixi-ros` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Once the `conda-forge` channel has been enabled, `pixi-ros` can be installed with `conda`:

```
conda install pixi-ros
```

or with `mamba`:

```
mamba install pixi-ros
```

It is possible to list all of the versions of `pixi-ros` available on your platform with `conda`:

```
conda search pixi-ros --channel conda-forge
```

or with `mamba`:

```
mamba search pixi-ros --channel conda-forge
```
...
mamba repoquery search pixi-ros --channel conda-forge

# List packages depending on `pixi-ros`:
mamba repoquery whoneeds pixi-ros --channel conda-forge

# List dependencies of `pixi-ros`:
mamba repoquery depends pixi-ros --channel conda-forge
```
...
Updating pixi-ros-feedstock
===========================

If you would like to improve the pixi-ros recipe or build a new
...
Note that all branches in the conda-forge/pixi-ros-feedstock are

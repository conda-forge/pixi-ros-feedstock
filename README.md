...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pixi-ros-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pixi-ros-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
It is possible to list all of the versions of `pixi-ros` available on your platform:
...
```
pixi search pixi-ros --channel conda-forge
```
